{ pkgs, pkgconf, shader-slang, vulkan-loader, vulkan-validation-layers, libffi,
  libdrm-ocaml, libinput-ocaml, olivine, linuxHeaders, ocamlPackages }:
...
pkgs.stdenv.mkDerivation {
  ...
  buildInputs = [
    pkgconf shader-slang vulkan-loader vulkan-validation-layers libffi libdrm-ocaml libinput-ocaml olivine
  ] ++ (with ocamlPackages; [
